...
+ '{{#_hasPaging}}'
+ '    <div class="ui-paging">'
+ '        <{{#_prevPage}}a{{/_prevPage}}{{^_prevPage}}span{{/_prevPage}} class="ui-paging-prev" onclick="pageChange({{_prevPage}})" >'
+ '            上一页'
+ '        </{{#_prevPage}}a{{/_prevPage}}{{^_prevPage}}span{{/_prevPage}}>'
+ '        {{^_isFirstPage}}'
+ '        <a onclick="pageChange(1)" class="ui-paging-item">1</a>'
+ '        {{/_isFirstPage}}'
+ '        {{#_hasBeforePages}}'
+ '        <span class="ui-paging-ellipsis">...</span>'
+ '        {{/_hasBeforePages}}'
+ '        {{#_beforePages}}'
+ '        <a class="ui-paging-item" onclick="pageChange({{.}})">{{.}}</a>'
+ '        {{/_beforePages}}'
+ '        <a onclick="pageChange({{_currentPage}})"  class="ui-paging-item ui-paging-current">{{_currentPage}}</a>'
+ '        {{#_afterPages}}'
+ '        <a class="ui-paging-item" onclick="pageChange({{.}})">{{.}}</a>'
+ '        {{/_afterPages}}'
+ '        {{#_hasAfterPages}}'
...
+ '        {{/_hasAfterPages}}'
+ '        {{^_isLastPage}}'
+ '        <a  onclick="pageChange({{_pageCount}})"  class="ui-paging-item">{{_pageCount}}</a>'
+ '        {{/_isLastPage}}'
+ '        <{{#_nextPage}}a{{/_nextPage}}{{^_nextPage}}span{{/_nextPage}} class="ui-paging-next" onclick="pageChange({{_nextPage}})" link>'
+ '            下一页'
...
+ '        <a class="ui-paging-info ui-paging-goto" onclick="pageChange({{_currentPage}})" >跳转</a>'
+ '    </div>'
+ '{{/_hasPaging}}'
